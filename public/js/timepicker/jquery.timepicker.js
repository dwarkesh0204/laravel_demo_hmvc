...
"undefined" != typeof jQuery && function(e) {
    ...
    e.TimePicker = function() {
        ...
        _move: function(e, t, i) {
            var n = this;
            if (n.closed() && n.open(e), !n.active) return n.activate(e, n.viewport.children(i)), undefined;
        ...
        select: function(t, i) {
            var n = this,
                r = t === !1 ? n.instance : t;
            clearTimeout(n.closing), n.setTime(r, e.fn.timepicker.parseTime(i.children("a").text())), n.close(r, !0)
        },
        ...
        open: function(t) {
            ...
            switch ((t.rebuild || !t.items || r) && (t.items = i._items(t, r ? n : null)), (t.rebuild || i.instance !== t || r) && ("1.4.2" > e.fn.jquery ? (i.viewport.children().remove(), i.viewport.append(t.items), i.viewport.find("a").bind("mouseover.timepicker", function() {
                i.activate(t, e(this).parent())
            }).bind("mouseout.timepicker", function() {
                i.deactivate(t)
            }).bind("click.timepicker", function(n) {
                n.preventDefault(), i.select(t, e(this).parent())
            ...
            i.container.css({
                ...
                left: o.left
            }), i.container.show(), i.container.css({
            ...
            return i.ui.css({
                ...
                width: u
            }), i.instance = t, n ? t.items.each(function() {
                var r, a = e(this);
                return r = "1.4.2" > e.fn.jquery ? e.fn.timepicker.parseTime(a.find("a").text()) : a.data("time-value"), r.getTime() === n.getTime() ? (i.activate(t, a), !1) : !0
            }) : i.deactivate(t), t.element
        },
        close: function(e, t) {
            var i = this;
        ...
        setTime: function(t, n, r) {
            ...
            return (null !== s || null !== t.selectedTime) && (t.element.trigger("time-change", [n]), e.isFunction(t.options.change) && t.options.change.apply(t.element, [n])), t.element
        },
