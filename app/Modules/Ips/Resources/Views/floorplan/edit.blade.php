...
"></canvas>
                        ...
                        <div class="floorplan-form">
                            {!! Form::model('',['method' => 'PATCH','route' => ['floorplan.update', $FloorplanData->id],'files' => true])!!}
                            <div class="col-md-12">
                                <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function ajaxGetAvailableGateway()
    {
        ...
        $('#apply_loader').show();
         $.ajax({
            url: '{{url('ips/floorplan/ajaxGetAvailableGateWay')}}',
            type: 'POST',
            async:false,
            data: {
                _token: CSRF_TOKEN,
    ...
    function add_beacon(){
        ...
        $('#apply_loader').show();
        $.ajax({
            url: '{{url('ips/floorplan/ajaxAddBeacon')}}',
            type: 'POST',
            data: {
                _token: CSRF_TOKEN,
                floorPlan:{{$id}},
    ...
    function excel_export(type)
    {
        ...
        $('#apply_loader').show();
        $.ajax({
            url: '{{url('ips/floorplan/ajaxExport')}}',
            type: 'POST',
            data: {
                _token: CSRF_TOKEN,
                type:type,
    ...
    function save_nodes_path()
    {
        ...
        $('#apply_loader').show();
        $.ajax({
            url: '{{url('ips/floorplan/ajaxInsertNodesPaths')}}',
            type: 'POST',
            data: {
                _token: CSRF_TOKEN,
                floorPlan:{{$id}},
