                ...
                {!! Form::open(array('route' => 'sessions.store','method'=>'POST')) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('event_id',(['0' => 'Select a Event'] + $events),NULL,['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('speaker_id','Speaker') !!}<br />
                            {!! Form::select('speaker_id',(['0' => 'Select a Speaker'] + $speakers),NULL,['name'=>'speaker_id[]','multiple'=>'multiple','class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
