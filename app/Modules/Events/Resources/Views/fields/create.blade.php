				...
				{!! Form::open(array('route' => 'fields.store','method'=>'POST')) !!}
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<div class="form-group">
								{!! Form::label('field_type', 'Select Field Type*:', ['class' => 'control-label']) !!}
							...
							<div class="form-group events" style="display:none;">
	                            ...
	                            {!! Form::select('event_id[]', $events, array(), ['class' => 'form-control','multiple' => 'multiple']) !!}
	                        </div>

	                        <div class="form-group roles" style="display:none;">
	                            {!! Form::label('role_id', 'Roles*:', ['class' => 'control-label']) !!}
	                            {!! Form::select('role_id[]', $roles, array(), ['class' => 'form-control','multiple' => 'multiple']) !!}
	                        </div>
