        ...
        <div class="span12">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="roles_detail">
                    ...
                    <!-- <div class="col-lg-12">
                        <a href="#roles_fields" class="btn pull-right" data-toggle="tab"><button type="button" class="btn btn-primary">Next</button></a>
                    </div>
                    -->
                </div>
