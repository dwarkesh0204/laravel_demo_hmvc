                ...
                {!! Form::open(array('route' => 'menu.store','method'=>'POST','files'=>'true')) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <div class="form-inline">
                                        <div class="radio">
                                            {{ Form::radio('default_page', '1', false)}}
                                            {{ Form::label('Yes', 'Yes')}}
                                        </div>
                                        <div class="radio">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-4">
                                    <div class="form-group">
                                        ...
                                        'cmspage' => 'cmsPage',
                                        'categoryblog' => 'Category Blog'
                                        ), null, ['class' => 'form-control screens','id' => 'screens', 'multiple' => 'multiple']) !!}
                                    </div>
                                </div>
                                <div class="form-group col-lg-4">
                        ...
                        <div class="form-group cmsPage" style="display:none">
                            ...
                            {!! Form::select('cmsPage', $cmsPages, null, ['class' => 'form-control','id' => 'cmsPage']) !!}
                        </div>
