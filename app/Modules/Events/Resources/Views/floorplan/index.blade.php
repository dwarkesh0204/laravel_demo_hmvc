        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <a class="btn btn-success" href="{{route('floorplans.create') }}">Create</a>
                        <input type="button" class="btn btn-danger" id="deleteFloorplan" value="Delete Floorplan">
                        {!! Form::open(['method' => 'DELETE','route' => ['floorplans.destroy'],'style'=>'display:inline', 'id' => 'deleteFloorplanForm']) !!}
    ...
    <script type="text/javascript">
        ...
        jQuery(function($) {
            $('#floorplanTable').DataTable({
                ...
                info:false,
                order: [[ 1, "desc" ]],
                ajax: '{!! url('events/data-table-floorplan') !!}',
                columns: [
                ...
                aoColumnDefs: [{
                    "aTargets": [ 1 ], // Column to target
                     "mRender": function ( data, type, full ) {
                         if (full.name != "")
                         {
                             returnStr =  '<a href="{{ url('events/floorplans')}}/'+full.id+'/edit">'+full.name+'</a>';
